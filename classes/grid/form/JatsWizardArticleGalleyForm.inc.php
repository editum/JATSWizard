...
/**
 * @file plugins/generic/jatsWizard/controllers/grid/form/JatsWizardArticleGalleyForm.inc.php
 *
 * Copyright (c) 2014-2019 Simon Fraser University
 * Copyright (c) 2003-2019 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class JatsWizardArticleGalleyForm
 *
...
class JatsWizardArticleGalleyForm extends Form
{
	/** @var the $_submission */
	...
	function __construct($request, $plugin, $publication, $submission)
	{
		...
		parent::__construct($plugin->getTemplateResource('JatsWizardArticleGalley.tpl'));
